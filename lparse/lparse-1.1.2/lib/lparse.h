...
const char *lparse_get_symbolic_constant_name(long symbolic_constant);
...
long lparse_get_symbolic_constant_index(const char *symbolic_constant);

/* Function lparse_symbol_exists(char*) returns true if its argument
   string is defined as a constant in the program. */
int lparse_symbol_exists(const char *symbolic_constant);
...
/* Function lparse_create_new_symbolic_constant(char*) stores its
   ...
   the same index */
long lparse_create_new_symbolic_constant(const char *new_string);
