...
public:
  bool special;
  bool ground; 	// true if ground literal
  bool negative;	// true if negative literal
  bool has_range; // true if one of arguments is a range
  bool has_function; // ditto for functions
  bool has_atom; // true if one of the arguments is another atom
  bool deleted;
  bool inverted;
  bool is_warned; // true, if we have warned about missing weights
  // before
  bool has_global_condition;
  bool ignore_global_condition;
  bool empty_condition; // true, if expansion of condition is empty
  bool is_symbolic_function;
...
public:
  ...
  Term *atleast;
  Term *atmost;
  bool dynamic_atleast;
  bool weight_atleast; 
  bool negatives_counted;
