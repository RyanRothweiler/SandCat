...
Function::Function(InstFunc f, ParseNode *pn, const char *n, long ln, int
		   ar) 
{
...
Function::Function(InstFunc f, const char *n, int ar, long ln) 
{
  type = T_FUNCTION;
...
Function::Function(const char *n, Term *left, Term *right, long ln)
{
